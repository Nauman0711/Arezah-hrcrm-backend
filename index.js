...
app.use('/api/auth/refreshToken', require("./src/routes/authentication/refresh-token/index"));
...
app.use("/api/employe", require("./src/routes/employes/get/index"));
...
app.use("/api/department", require("./src/routes/department/get/index"));
app.use("/api/department", require("./src/routes/department/update/index"));

// Home routes
app.use("/api/home", require("./src/routes/home/index"));
